...
namespace PacManBot.Modules
{
    partial class MoreGamesModule
    {
       ...
       + "\n • When you only have one card left, you must say \"**uno**\" (You can add it to your card like \"red4 uno\", or you can say it directly after if you forget). If you forget, someone else can say \"uno\" to call you out before the next player plays, and you will draw 2 cards."
