...
namespace PacManBot.Games
{
    public struct Pos
    {
        ...
        public static Pos operator +(Pos pos1, Pos pos2)
            => new Pos(pos1.x + pos2.x, pos1.y + pos2.y);

        public static Pos operator -(Pos pos1, Pos pos2)
            => new Pos(pos1.x - pos2.x, pos1.y - pos2.y);

        public static Pos operator +(Pos pos, Dir dir)
            => pos + dir.ToPos();

        public static Pos operator *(Pos pos, int mult)
            => new Pos(pos.x * mult, pos.y * mult);
